...
theory:
  ...
  - topic: Fundamental Assumptions
    ...
    content: "Here is how Dennis Bakke (CEO of AES at that time) summarizes the
      assumptions workers feel bosses have about them:\r
      ...
      * Workers work primarily for money. They will do what it takes to
      make as much money as possible.\r

      * Workers put their own interest ahead of what is best for the
      organization. They are selfish.\r

      * Workers perform best and are most effective if they have one
      simple repeatable task to accomplish.\r

      * Workers are not capable of making good decisions about important
      matters that affect the economic performance of the company. Bosses are
      good at making decisions.\r

      * Workers do not want to be responsible for their actions or for
      decisions that affect the performance of the organization.\r

      * Workers need care and protection, just as children need the care
      of their parents.\r

      * Workers should be compensated by the hour or by the number of
      \"pieces\" produced. Bosses should be paid a salary and possibly receive
      bonuses and stock.\r

      * Workers are like interchangeable parts of machines. One \"good\"
      worker is pretty much the same as another \"good\" worker.\r

      * Workers need to be told what to do, when to do it, and how to do
      it.  Bosses need to hold them accountable.\r


      And here are the new assumptions :\r
      ...
      * Are accountable and responsible for their decisions and actions;\r

      * Are fallible. We make mistakes, sometimes on purpose;\r
